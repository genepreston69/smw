...
export default async function AppLayout({
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside className="fixed inset-y-0 left-0 z-20 flex w-48 flex-col bg-navy-950">
      ...
      {/* Main */}
      <div className="ml-48 flex min-h-screen min-w-0 flex-1 flex-col">
        <main className="mx-auto w-full max-w-[1480px] flex-1 px-6 py-8">
          {children}
        </main>
      </div>
    </div>
